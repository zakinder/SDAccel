...
HD_PWD='C:/Sim/sdaccel_ku/xcl_design/xcl_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xcl_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xcl_design_wrapper.tcl -notrace
