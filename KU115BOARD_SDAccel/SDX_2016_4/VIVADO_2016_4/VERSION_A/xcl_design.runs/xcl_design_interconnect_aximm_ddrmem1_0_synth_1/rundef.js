...
ISEStep( "vivado",
         "-log xcl_design_interconnect_aximm_ddrmem1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcl_design_interconnect_aximm_ddrmem1_0.tcl" );
