...
ISEStep( "vivado",
         "-log xcl_design_psreset_gate_pr_control_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcl_design_psreset_gate_pr_control_0.tcl" );
