...
HD_PWD='C:/Sim/sdaccel_ku/xcl_design/xcl_design.runs/xcl_design_concat_flash_tri_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xcl_design_concat_flash_tri_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcl_design_concat_flash_tri_0.tcl
