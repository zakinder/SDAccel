...
//Date        : Tue May 16 09:08:19 2017
//Host        : SakinderLaptop1 running 64-bit major release  (build 9200)
//Command     : generate_target bd_8917.bd
//Design      : bd_8917
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_8917,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_8917,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "xcl_design_ddrmem_0_0_microblaze_mcs.hwdef" *) 
module bd_8917
   (Clk,
    IO_addr_strobe,
    IO_address,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_8917 lmb_bram_I bd_8917 second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_8917_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_8917_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_8917_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_8917_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_8917 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_8917_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_8917_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_8917_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_8917_second_lmb_bram_I_0 second_lmb_bram_I
