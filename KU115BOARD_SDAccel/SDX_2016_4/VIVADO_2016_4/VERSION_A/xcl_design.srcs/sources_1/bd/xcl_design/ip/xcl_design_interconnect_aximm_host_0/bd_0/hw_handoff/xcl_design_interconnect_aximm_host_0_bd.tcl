...
################################################################
# This is a generated script based on design: bd_d184
#
...
CONFIG.SEG002_BASE_ADDR {0x0000000200000000} \
...
CONFIG.MSC002_RDATA_WIDTH {256} \
CONFIG.MSC002_WDATA_WIDTH {256} \
CONFIG.MSC003_RDATA_WIDTH {256} \
CONFIG.MSC003_WDATA_WIDTH {256} \
CONFIG.MSC004_RDATA_WIDTH {256} \
CONFIG.MSC004_WDATA_WIDTH {256} \
CONFIG.NUM_MSC {5} \
...
CONFIG.USER_WIDTH {0} \
  ...
  # Create port connections
  connect_bd_net -net m_axi_aclk_1 [get_bd_pins m_axi_aclk] [get_bd_pins m04_ar_node/m_sc_aclk] [get_bd_pins m04_r_node/s_sc_aclk]
  connect_bd_net -net m_axi_aresetn_1 [get_bd_pins m_axi_aresetn] [get_bd_pins m04_ar_node/m_sc_aresetn] [get_bd_pins m04_r_node/s_sc_aresetn]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins m04_ar_node/s_sc_aclk] [get_bd_pins m04_r_node/m_sc_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins m04_ar_node/s_sc_aresetn] [get_bd_pins m04_r_node/m_sc_aresetn]
...
CONFIG.C_AUX_RST_WIDTH {1} \
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins M04_ACLK] [get_bd_pins aclk1] [get_bd_pins psr_aclk1/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins M01_ACLK] [get_bd_pins M02_ACLK] [get_bd_pins M03_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M04_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
