...
//Date        : Tue May 16 09:08:43 2017
//Host        : SakinderLaptop1 running 64-bit major release  (build 9200)
//Command     : generate_target bd_b3eb.bd
//Design      : bd_b3eb
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_b3eb,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_b3eb,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "xcl_design_ddrmem_1_0_microblaze_mcs.hwdef" *) 
module bd_b3eb
   (Clk,
    IO_addr_strobe,
    IO_address,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_b3eb lmb_bram_I bd_b3eb second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_b3eb_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_b3eb_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_b3eb_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_b3eb_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_b3eb dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_b3eb_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_b3eb_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_b3eb_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_b3eb_second_lmb_bram_I_0 second_lmb_bram_I
