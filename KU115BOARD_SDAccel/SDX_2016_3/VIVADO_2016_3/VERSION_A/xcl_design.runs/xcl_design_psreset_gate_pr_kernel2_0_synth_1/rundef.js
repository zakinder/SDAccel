...
ISEStep( "vivado",
         "-log xcl_design_psreset_gate_pr_kernel2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcl_design_psreset_gate_pr_kernel2_0.tcl" );
