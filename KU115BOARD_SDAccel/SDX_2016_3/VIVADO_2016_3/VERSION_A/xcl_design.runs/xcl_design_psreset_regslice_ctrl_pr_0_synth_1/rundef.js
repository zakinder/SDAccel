...
ISEStep( "vivado",
         "-log xcl_design_psreset_regslice_ctrl_pr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcl_design_psreset_regslice_ctrl_pr_0.tcl" );
