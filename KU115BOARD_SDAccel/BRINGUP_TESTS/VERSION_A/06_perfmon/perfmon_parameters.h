...
/* AXI Monitor Min/Max latency register offsets (profile mode only) */

#define XAPM_SLOT0_WRITE_MINMAX_OFFSET  0x0254  /**< sampled slot 0 write min/max latency */
#define XAPM_SLOT0_READ_MINMAX_OFFSET   0x0258  /**< sampled slot 0 read min/max latency */

#define XAPM_SLOT1_WRITE_MINMAX_OFFSET  0x02B4  /**< sampled slot 1 write min/max latency */
#define XAPM_SLOT1_READ_MINMAX_OFFSET   0x02B8  /**< sampled slot 1 read min/max latency */

#define XAPM_SLOT2_WRITE_MINMAX_OFFSET  0x0654  /**< sampled slot 2 write min/max latency */
#define XAPM_SLOT2_READ_MINMAX_OFFSET   0x0658  /**< sampled slot 2 read min/max latency */

#define XAPM_SLOT3_WRITE_MINMAX_OFFSET  0x06B4  /**< sampled slot 3 write min/max latency */
#define XAPM_SLOT3_READ_MINMAX_OFFSET   0x06B8  /**< sampled slot 3 read min/max latency */

#define XAPM_SLOT4_WRITE_MINMAX_OFFSET  0x0854  /**< sampled slot 4 write min/max latency */
#define XAPM_SLOT4_READ_MINMAX_OFFSET   0x0858  /**< sampled slot 4 read min/max latency */

#define XAPM_SLOT5_WRITE_MINMAX_OFFSET  0x08B4  /**< sampled slot 5 write min/max latency */
#define XAPM_SLOT5_READ_MINMAX_OFFSET   0x08B8  /**< sampled slot 5 read min/max latency */

#define XAPM_SLOT6_WRITE_MINMAX_OFFSET  0x0A54  /**< sampled slot 6 write min/max latency */
#define XAPM_SLOT6_READ_MINMAX_OFFSET   0x0A58  /**< sampled slot 6 read min/max latency */

#define XAPM_SLOT7_WRITE_MINMAX_OFFSET  0x0AB4  /**< sampled slot 7 write min/max latency */
#define XAPM_SLOT7_READ_MINMAX_OFFSET   0x0AB8  /**< sampled slot 7 read min/max latency */
