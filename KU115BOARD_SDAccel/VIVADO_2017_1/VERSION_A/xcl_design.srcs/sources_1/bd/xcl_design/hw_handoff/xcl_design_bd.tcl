...
CONFIG.NUM_PORTS {4} \
  ...
  set debug_bridge_xsdbm [ create_bd_cell -type ip -vlnv xilinx.com:ip:debug_bridge:2.0 debug_bridge_xsdbm ]
  set_property -dict [ list \
...
CONFIG.NUM_PORTS {4} \
  ...
  set ddrmem_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.2 ddrmem_0 ]
  set_property -dict [ list \
...
CONFIG.C0.DDR4_isCustom {false} \
  ...
  set ddrmem_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.2 ddrmem_2 ]
  set_property -dict [ list \
CONFIG.C0.ControllerType {DDR4_SDRAM} \
CONFIG.C0.DDR4_AxiAddressWidth {32} \
CONFIG.C0.DDR4_AxiDataWidth {512} \
...
CONFIG.C0.DDR4_isCustom {false} \
  ...
  set ddrmem_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4:2.2 ddrmem_3 ]
  set_property -dict [ list \
CONFIG.C0.ControllerType {DDR4_SDRAM} \
CONFIG.C0.DDR4_AxiAddressWidth {32} \
CONFIG.C0.DDR4_AxiDataWidth {512} \
...
CONFIG.C_BUF_TYPE {IBUFDSGTE} \
  ...
  set clkwiz_kernel [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 clkwiz_kernel ]
  set_property -dict [ list \
...
CONFIG.USE_DYN_RECONFIG {true} \
  ...
  set clkwiz_kernel2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 clkwiz_kernel2 ]
  set_property -dict [ list \
...
CONFIG.USE_DYN_RECONFIG {true} \
  ...
  set clkwiz_sysclks [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 clkwiz_sysclks ]
  set_property -dict [ list \
...
CONFIG.C_DEFAULT_VALUE {0x01} \
  ...
  set dma_pcie [ create_bd_cell -type ip -vlnv xilinx.com:ip:xdma:3.1 dma_pcie ]
  set_property -dict [ list \
